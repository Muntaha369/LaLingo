...
def upload_aud(vid_aud, summary = False, language = "English"):
    
    vid_summary = remove_not_wav_and_convert_wav_chunk(vid_aud)
    ...
    if summary == True:
        res = get_summaries(content, language)

    return res

def get_summaries(content, language):
            ...
            "messages": [
                {
                    ...
                    Summarize this whole transcript in {language}
                    """
                }
            ]
        })
